    ...
    <div className='text-gray-500 grid place-items-center align-middle h-screen' style={styles}>
      ...
      <div className='w-{80%} h-{60%} md:w-1/3 md:h-2/3 px-8 py-24 bg-black/80 absolute rounded'>
        <form className='flex flex-col space-y-5 z-10'>
          ...
          <input className='bg-gray-800 rounded px-1 h-9 text-white w-full  border-none' type='text' placeholder='email' id='email' name='email'></input>
          <input className='bg-gray-800 rounded px-1 h-9 text-white  border-none' type='password' placeholder='password' id='password' name='password'></input>
          <br />
