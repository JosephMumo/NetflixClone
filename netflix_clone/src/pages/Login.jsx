  ...
  return (
    <div className='text-white grid place-items-center align-middle h-screen bg-gradient-to-r from-black' style={styles}>
      ...
      <form className='flex flex-col w-1/2 space-y-5 items-center z-10 text-center'>
        ...
        <input className='bg-inherit text-white w-full md:w-1/2  border-b border-white' placeholder='Name' id='name' name='fname'></input>
        <input className='bg-inherit text-white w-full md:w-1/2 border-b border-white' placeholder='Email' id='email' name='email'></input>
